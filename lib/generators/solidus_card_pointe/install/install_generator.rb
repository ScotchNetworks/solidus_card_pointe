  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_stylesheets
        ...
        inject_into_file 'vendor/assets/stylesheets/spree/backend/all.css', " *= require spree/backend/solidus_card_pointe\n", before: %r{\*/}, verbose: true # rubocop:disable Layout/LineLength
      end

      def add_migrations
        run 'bin/rails railties:install:migrations FROM=solidus_card_pointe'
      end
